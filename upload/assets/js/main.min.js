(function () {
 ...
 try {
  ...
  document.documentElement.setAttribute('data-theme', (hour >= 7 && hour < 18) ? 'light' : 'dark');
...
export function initTheme() {
 ...
 const initial = saved || getTimeBasedTheme();
 applyTheme(initial);
 if (toggle) {
 ...
 setInterval(() => {
 if (!localStorage.getItem('em-theme')) applyTheme(getTimeBasedTheme());
 }, 60000);
